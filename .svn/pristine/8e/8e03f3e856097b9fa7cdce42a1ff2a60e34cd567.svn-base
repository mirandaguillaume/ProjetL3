...
use ProjetL3\TagBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjetL3TagBundle:Tag')->findAll();

        return $this->render('ProjetL3TagBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ProjetL3TagBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjetL3TagBundle:Tag')->find($id);
        ...
        return $this->render('ProjetL3TagBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProjetL3TagBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
